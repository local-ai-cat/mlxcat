...
/// `TokenIterator` loop; the native path is `MLXCatEngine` over
...
final class Width1ThroughputTests: XCTestCase {
    ...
    private static func measure(context: ModelContext) async throws -> String {
        ...
        func runEngine(_ engine: MLXCatEngine, uid: String) async throws -> Sample {
            let request = Request(
                uid: uid,
                input: input,
